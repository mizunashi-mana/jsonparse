...
export class ParseErrorStocker {
   ...
   */
  public addChild(value: ParseErrorNode): ParseErrorStocker;
  /**
   * return new stocker added child
   *
   ...
   * @returns new stocker including new child
   */
  public addChild(pname: string, stocker: ParseErrorStocker): ParseErrorStocker;
  public addChild(arg1: (string|ParseErrorNode), arg2?: ParseErrorStocker) {
    if (typeof arg1 === 'string') {
   ...
   */
  public addChilds(nodes: ParseErrorNode[]) {
    return new ParseErrorStocker(
      this.innerMsg,
      this.innerExpected,
      this.innerActual,
   ...
   */
  public desc(msg: string, exp?: string, act?: string) {
    return new ParseErrorStocker(
      msg,
   ...
   */
  public report(f: (msg?: string, exp?: string, act?: string, childs?: ParseErrorNode[]) => any): void {
